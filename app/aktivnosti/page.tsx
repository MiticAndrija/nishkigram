...
export const metadata = {
  title: "Aktuelnost u Nišu - Niškigram",
        ...
        <section className="px-4 pb-14 pt-12 sm:px-6 md:px-10 md:pb-24 md:pt-16">
          <div className="mx-auto max-w-6xl">
            <div className="max-w-3xl">
              <h1 className="font-serif text-4xl leading-tight text-[#4a382b] sm:text-5xl md:text-7xl">Aktuelnost</h1>
            ...
            ) : <p className="mt-12 rounded-[1.25rem] border border-[#5c4a3d]/10 bg-[#fdfaf6] p-6 leading-7 text-[#5c4a3d]/75">Trenutno nema najavljenih aktuelnosti.</p>}
          </div>
        </section>
      </main>
    </div>
